...
class neural_function:
    ...
    def __init__(self, training_dataset, training_targets, lr = 0.004):
        ...
        self.weights_ih = (2 * np.random.random((len(self.training_dataset[0]), 40)) - 1) * np.sqrt(10.0/784)
        self.weights_ho = (2 * np.random.random((40, 10)) - 1) * np.sqrt(10.0/40.0)
...
def main():
    ...
    #Initiate
    ANN = neural_function(training_data, training_targets)
